...
#define OBS_VERSION             0x005403 //version number is 0xMMmmtt (Major.minor.test - yes I know it's hex)
#define OBS_VERSION_STRING_ANSI "Open Broadcaster Software v0.54.03 network test"
