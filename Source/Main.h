...
#define OBS_VERSION             0x005205 //version number is 0xMMmmtt (Major.minor.test - yes I know it's hex)
#define OBS_VERSION_STRING_ANSI "Open Broadcaster Software v0.52.05b powdered toast build"
