...
#define OBS_VERSION             0x005704 //version number is 0xMMmmtt (Major.minor.test - yes I know it's hex)
#define OBS_VERSION_STRING_RAW  "Open Broadcaster Software v0.57.04 quicksync tests"
